/**
 * # 1
 * The first version of extending IntSet 1
 * Has bugs
 */
...
public class InstrumentedIntSet1
    ...
    public void addAll(int... values) {
        ...
        // This is the bug! GOTCHA, it doubles adds the element, as we call the super.addAll method,
        // and it InSet1 class, it calls add method, which we have override, and he line 23 have updated the count,
        // So the following line will double count

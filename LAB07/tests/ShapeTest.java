...
public class ShapeTest {
  ...
  public void setup() {
    ...
    point2 = new Point2D(6, 7);
    tri1 = new Triangle(2, 3, 4, 5, 6, 7);
    tri2 = new Triangle(2, 3, point1, point2);
    tri3 = new Triangle(5.5, 6.6, 3.3, 4.4, 7.7, 8.8);
  ...
  public void testObjectData() {
    ...
    assertEquals(
        ...
        tri2.toString());
    assertEquals(
        "Triangle: Reference point:(5.500,6.600) Second point:(3.300,4.400) Third point:(7.700,8.800)",
        tri3.toString());
  }
  ...
  public void testArea() {
    ...
    assertEquals(40,tri2.area(), 0.001);
    assertEquals(9, tri3.area(), 0.001);
  }
  ...
  public void testPerimeter() {
    ...
    assertEquals(9, tri1.perimeter(), 0.001);
    assertEquals(40,tri2.perimeter(), 0.001);
    assertEquals(9, tri3.perimeter(), 0.001);
  ...
  @Test
  public void testcompareTo(Shape s){

...
public class ItemImportanceComparator implements Comparator<Item> {
   ...
   * {@link Integer#signum signum}{@code (compare(x, y)) == -signum(compare(y, x))} for all
   ...
   *                              comparator. //@apiNote It is generally the case, but <i>not</i>
  ...
  public int compare(Item i1, Item i2) {
    int importanceThis = i1.getImportance();
    int importanceOther = i2.getImportance();

    return Integer.compare(importanceThis, importanceOther);
  }
}
